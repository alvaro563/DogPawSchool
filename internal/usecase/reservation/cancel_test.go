...
func nearFutureActivity(id int) *domain.Activity {
	return domain.MustNewActivity(id, "Paseo", "", "Central", domain.TypeRoute, 5, 1, fixedNow.Add(1*time.Hour), nil, nil)
}
...
func pastActivity(id int) *domain.Activity {
	return domain.MustNewActivity(id, "Paseo", "", "Central", domain.TypeRoute, 5, 1, fixedNow.Add(-24*time.Hour), nil, nil)
}
