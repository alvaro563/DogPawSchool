...
// InactiveDogsManagementPage: lists dogs with is_active=false. Same
// shape as DogsManagementPage (tabs + per-column search + grid) but
// rendered for the inactive cohort. Reached via the "Ver perros
// inactivos" button at the bottom of the active list.
export function InactiveDogsManagementPage() {
  ...
  return (
    <div className="space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <button
            onClick={() => navigate({ to: '/admin/dogs' })}
            className="mb-1 inline-flex items-center gap-1 text-xs font-medium text-muted-foreground transition-colors hover:text-foreground"
          >
            <ArrowLeft className="h-3 w-3" />
            Volver a perros activos
          </button>
